public class FinalProject {
    ...
    private boolean hasNeighbor(int[][] matrix, int i, int j) {
    ...
    private void doDFS(int[][] matrix, int i, int j, boolean[][] visited) {
        ...
        for (int l = 0; l < offsets.length; l++) {
            ...
            for (int m = 0; m < offsets.length; m++) {
                ...
                if (hasNeighbor(matrix, i + xOffset, j + yOffset)) {
    ...
    public static void main(String[] args) {
        ...
        FinalProject islands = new FinalProject();

        System.out.println();
        System.out.println("Number of Islands: " + islands.findIslands(matrix));
    }
}